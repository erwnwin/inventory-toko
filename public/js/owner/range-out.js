$(document).ready(function() {
    ...
    function fetchAllData() {
        ...
        $.ajax({
            url: 'barang-keluar', // Adjust URL as per your controller method
            ...
            success: function(data){
                ...
                $('#filteredDataOut').empty();
                
                if (data.length === 0) {
                    $('#filteredDataOut').append('<tr><td colspan="7" class="text-center">Tidak ada data yang tersedia....</td></tr>');
                } else {
                    ...
                    $.each(data, function(index, item) {
                        var row = '<tr>' +
                                ...
                                '<td>' +
                                    ...
                                    '<form action="barang-keluar/delete" method="post" class="d-inline">' +
    ...
    $('#filterFormOut').submit(function(e) {
        ...
        $.ajax({
            url: 'filter/get-out', // Ganti sesuai dengan URL controller dan method di CodeIgniter
            type: 'POST',
            dataType: 'json',
            data: {
