                         ...
                         <div class="col-lg-8 col-12">
                             ...
                             <div class="card">
                                 <div class="card-header">
                                     <h3 class="card-title">Form Create Item Products</h3>
                                 ...
                                 <div class="card-body p-0">
                                     <form class="form-horizontal" id="createItemProducts" enctype="multipart/form-data">
                                         <div class="card-body">
                                             <div class="form-group row">
                                                 <label for="inputEmail3" class="col-sm-4 col-form-label">Barcode / Kode Product</label>
                                                 <div class="col-sm-8">
                                                     <input type="text" name="barcode" class="form-control" id="barcode" value="<?php echo $barcode; ?>" readonly autocomplete="off" required>
                                                 </div>
                                             </div>
                                             ...
                                             <div class="form-group row">
                                                 ...
                                                 <div class="col-sm-8">
                                                     <input type="text" name="nama_produk" class="form-control" id="nama_produk" autocomplete="off" placeholder="Nama Produk">
                                                 </div>
                                             </div>
                                             ...
                                             <div class="form-group row">
                                                 <label for="inputPassword3" class="col-sm-4 col-form-label">Unit</label>
                                                 <div class="col-sm-8">
                                             ...
                                             <div class="form-group row">
                                                 ...
                                                 <div class="col-sm-8">
                                                     <input type="number" name="price" class="form-control" id="price" placeholder="Enter number" autocomplete="off">
                                                 </div>
                                             </div>
                                         ...
                                         <div class="card-footer">
                                             ...
                                             <button type="submit" class="btn btn-success btn-sm float-right" id="btnSaveItem">
                                                 Simpan
                                             </button>
                                         </div>
