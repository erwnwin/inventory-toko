...
class M_item extends CI_Model
{
    ...
    {
        $this->db->select('produk_item.*, produk_item.stock,  produk_category.name as name_category, produk_unit.name as name_unit');
        $this->db->from('produk_item');
        $this->db->join('produk_category', 'produk_item.category_id = produk_category.category_id');
        $this->db->join('produk_unit', 'produk_item.unit_id = produk_unit.unit_id');
        if ($id != null) {
